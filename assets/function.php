...
function makeTransaction($action, $amount, $other)
{
    ...
    return $con->query("insert into transaction (action,debit,other,userId) values ('deduction','$amount','$other','$_SESSION[userId]')");
}
...
function makeTransactionCashier($action, $amount, $other, $userId)
{
    ...
    return $con->query("insert into transaction (action,debit,other,userId) values ('deduction','$amount','$other','$userId')");
}
